export const navigateToCalendly = () => {
  ...
  if (typeof window !== "undefined") {
    ...
    if (window.lintrk) {
      console.log("LinkedIn tracking disponible, déclenchement de l'évènement conversion.");
    ...
    console.log("gtag et LinkedIn tracking non disponibles, redirection immédiate.");
    redirect();
  }
};
