    ...
    <div id='process' className='min-h-screen text-gray-900'>
      <section className='py-16 px-6 text-center'>
        ...
        <p className='text-md mt-2 max-w-3xl mx-auto text-gray-600'>
          De la prise de contact à l’organisation complète de votre voyage, nous offrons un service clé en main pour
        ...
        <div className='grid grid-cols-1 md:grid-cols-2 gap-8 mt-12 max-w-5xl mx-auto'>
          ...
          <div className='flex items-center bg-gray-50 p-6 rounded-lg shadow hover:shadow-md transition-all'>
            <span className='text-3xl text-[var(--accent-color)] mr-4'>📝</span>
            <div className='text-left'>
              <h3 className='text-lg font-semibold'>2. Conception sur-mesure</h3>
              <p className='text-sm text-gray-600'>
          ...
          <div className='flex items-center bg-gray-50 p-6 rounded-lg shadow hover:shadow-md transition-all'>
            ...
            <div className='text-left'>
              <h3 className='text-lg font-semibold'>4. Organisation complète</h3>
              <p className='text-sm text-gray-600'>
          ...
          <div className='flex items-center bg-gray-50 p-6 rounded-lg shadow hover:shadow-md transition-all'>
            <span className='text-3xl text-[var(--accent-color)] mr-4'>💬</span>
            <div className='text-left'>
              <h3 className='text-lg font-semibold'>6. Suivi personnalisé sur place</h3>
              <p className='text-sm text-gray-600'>
      ...
      <section className='bg-[var(--accent-color)] text-white py-12 px-8 text-center'>
        <h2 className='text-2xl font-bold'>Prêt à commencer votre aventure ?</h2>
        <p className='text-md mt-2 max-w-xl mx-auto'>
          Réservez dès maintenant votre appel et laissez-nous créer votre voyage sur-mesure.
        </p>
        <a
