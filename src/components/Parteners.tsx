...
const Partners: React.FC = () => {
  ...
  return (
    <section id='partners' className='pb-20 pt-10 bg-gradient-to-b from-[#F9F9F9] to-white text-center px-6'>
      ...
      <p className='text-lg mt-4 max-w-3xl mx-auto text-gray-700 leading-relaxed'>
        Avec nos partenaires d'exception, nous transformons vos rêves en voyages mémorables. Ils garantissent une
        expérience sans compromis.
      </p>

      <div ref={scrollContainer} className='flex overflow-x-hidden mt-12 max-w-6xl mx-auto relative'>
        {[...partners, ...partners].map((partner, index) => (
          ...
          >
            <img src={partner.logo} alt={`Logo de ${partner.name}`} className='h-20 object-contain' />
          </div>
        ))}
      </div>
    </section>
