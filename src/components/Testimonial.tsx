const Testimonials: React.FC = () => {
  ...
  return (
    <section id='testimonials' className='py-20 bg-gradient-to-b from-[#F9F9F9] to-white text-center px-6'>
      <h2 className='text-4xl font-bold text-gray-900'>Des expériences inoubliables racontées par nos clients</h2>
      <p className='text-lg mt-4 max-w-3xl mx-auto text-gray-700 leading-relaxed'>
        Découvrez comment Elevia a transformé leurs voyages avec une expertise, un souci du détail et un service
        irréprochable.
      </p>
      ...
      <div className='grid md:grid-cols-3 gap-12 mt-12 max-w-6xl mx-auto'>
        {testimonials.map((testimonial, index) => (
          ...
          >
            ...
            <p className='text-lg text-gray-800 leading-relaxed italic mt-8'>{testimonial.text}</p>
            <div className='mt-4 text-[var(--accent-color)] font-semibold text-sm'>— {testimonial.name}</div>
